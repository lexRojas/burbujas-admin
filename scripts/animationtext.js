export default function AnimationText() {
  ...
  let proporcion_w = w / 1370;

  let opts = {
    // change the text in here //
    strings: ["APROVECHE", "BLACK FRIDAY!", "2024"],
    charSize: 100 * proporcion_w,
    charSpacing: 100 * proporcion_w,
    lineHeight: 150 * proporcion_w,
    ...
    fireworkCircleBaseSize: 60 * proporcion_w,
    ...
    balloonBaseSize: 60 * proporcion_w,
    balloonAddedSize: 20,
    balloonBaseVel: 0.4,
    balloonAddedVel: 0.4,
